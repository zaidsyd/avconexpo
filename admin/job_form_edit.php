...
$que = "SELECT * FROM add_job_post WHERE id = $user_id";
...
if (isset($_POST['submit']))
{
    ...
    if (isset($_FILES['image_path']) && $_FILES['image_path']['error'] == 0)
    {
        ...
        $image_path = 'apply_job/' . uniqid('career_', true) . '.' . $image_ext;
        move_uploaded_file($_FILES['image_path']['tmp_name'], $image_path);
    }

    $sql = "UPDATE add_job_post SET 
        name = '$name', 
        phone = '$phone', 
        email = '$email', 
        job_title = '$job_title',
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Update Job Apply Details</h4>
                    </div>
                    <div class="card-body">
