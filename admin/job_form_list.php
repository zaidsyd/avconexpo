                    ...
                    <div class="table-responsive">
                        <table class="table header-border table-responsive-sm">
                            ...
                            <tbody id="tableBody">
                                ...
                                $sel_que = "SELECT * FROM add_job_post";
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if ($file)
                                            {
                                                ...
                                                {
                                                    echo "<a href='$file' target='_blank'><img width='50' height='50' src='https://img.icons8.com/ios-filled/50/FA5252/pdf--v1.png' /></a>";
                                                } elseif (in_array($ext, ['doc', 'docx']))
                                                {
                                                    echo "<a href='$file' target='_blank'><img width='50' height='50' src='https://img.icons8.com/glyph-neue/64/FA5252/word.png' /></a>";
                                                } else
                                                {
                                                    echo "<a href='$file' target='_blank'><img width='50' height='50' src='https://img.icons8.com/glyph-neue/64/FA5252/word.png' /></a>";
                                                }
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-primary shadow btn-xs sharp me-1"
                                                href="job_form_edit.php?user_id=<?php echo $row['id']; ?>"
                                                style="color:white;">
                                                <i class="fas fa-pencil-alt"></i>
                                            </a>
                                            <form method="POST" action="job_form_delete.php" style="display:inline;">
