...
--
-- Host: localhost:3306
-- Generation Time: Apr 11, 2025 at 05:41 PM
...
--
CREATE DATABASE IF NOT EXISTS `avconexp_avconexpo_db` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `avconexp_avconexpo_db`;
...
CREATE TABLE `blogs` (
  ...
  `blog_desc_first` text,
  `blog_desc_second` text,
